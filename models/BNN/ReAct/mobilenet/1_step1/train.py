...
parser.add_argument('--log', default='EXP', type=str, help='writer log save name')
parser.add_argument('--print-freq', type=int, default=100,help='the print frequency of train and validate')
...
args.log = 'train-{}-{}'.format(args.log, time.strftime("%Y%m%d-%H%M%S"))
writer_comment = args.log
writer = SummaryWriter(log_dir = args.log, comment=writer_comment)
...
def main():
    ...
    while epoch < args.epochs:
        ...
        writer.add_scalars('Loss/Training-Validate', {
            'train_loss': train_obj,
            'validate_loss': valid_obj
        }, epoch + 1)
        writer.add_scalars('Acc1/Training-Validate', {
            'train_acc1': train_top1_acc,
            'validate_acc1': valid_top1_acc
        }, epoch + 1)
        writer.add_scalars('Acc5/Training-Validate', {
            'train_acc5': train_top5_acc,
            'validate_acc5': valid_top5_acc
        }, epoch + 1)
