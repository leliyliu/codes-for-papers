...
def rbnn_resnet20_1w1a(**kwargs):
    return ResNet(BasicBlock_1w1a, [3, 3, 3], **kwargs)

def rbnn_resnet32_1w1a(**kwargs):
    return ResNet(BasicBlock_1w1a, [5, 5, 5], **kwargs)
...
def resnet18A_1w1a(**kwargs):
    return CResNet(BasicBlock, [2,2,2,2], [32,32,64,128],**kwargs)

def resnet18B_1w1a(**kwargs):
    return CResNet(BasicBlock, [2,2,2,2], [32,64,128,256],**kwargs)

def resnet18C_1w1a(**kwargs):
    return CResNet(BasicBlock, [2,2,2,2], [64,64,128,256],**kwargs)
