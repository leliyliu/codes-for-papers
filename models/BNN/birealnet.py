...
__all__ = ['birealnet18', 'birealnet34', 'birealnet20', 'birealnet32']
...
class CifarBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, downsample=None) -> None:
        ...
        self.binary_conv1 = HardBinaryConv(in_planes, planes, stride=stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.move1 = LearnableBias(planes)
...
class CifarBiRealNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        super(CifarBiRealNet, self).__init__()
        self.in_planes = 16 
...
def birealnet20(pretrained=False, **kwargs):
    model = CifarBiRealNet(CifarBlock, [3,3,3], **kwargs)
    return model 

def birealnet32(pretrained=False, **kwargs):
    model = CifarBiRealNet(CifarBlock, [5,5,5], **kwargs)
    return model 
